...
**Wisp 0.5.5** lets a turn attach PDF, text, and video as well as images, makes
the phone terminal scroll, copy, and paste, and relaunches Desktop cleanly after
an in-app update. The 0.5 series brought the daemon and Desktop app
...
See [0.5.5 release notes](docs/v0.5/RELEASE-NOTES-0.5.5.md) and the
...
```sh
version=0.5.5 # replace with the current published release
...
artifact=dist/release/v0.5.5/wisp-v0.5.5-linux-x86_64
...
```sh
version=0.5.5 # replace with the installed version
curl --proto '=https' --tlsv1.2 -fsSL \
...
- [Desktop updates](docs/DESKTOP-UPDATES.md)
- [0.5.5 release notes](docs/v0.5/RELEASE-NOTES-0.5.5.md)
