...
still has gaps; see the [qualification ledger](v0.6/QUALIFICATION.md).
...
This pins the installer to release `0.6.1`. It verifies the binary checksum,
...
```sh
curl --proto '=https' --tlsv1.2 -fsSL \
  https://raw.githubusercontent.com/Pepewitch/wisp/v0.6.1/scripts/install.sh \
  -o install-wisp.sh
...
```sh
curl --proto '=https' --tlsv1.2 -fsSL \
  https://raw.githubusercontent.com/Pepewitch/wisp/v0.6.1/scripts/uninstall.sh | sh
```
