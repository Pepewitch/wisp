...
This pins the installer to release `0.6.3`. It verifies the binary checksum,
...
```sh
curl --proto '=https' --tlsv1.2 -fsSL \
  https://raw.githubusercontent.com/Pepewitch/wisp/v0.6.3/scripts/install.sh \
  -o install-wisp.sh
...
```sh
curl --proto '=https' --tlsv1.2 -fsSL \
  https://raw.githubusercontent.com/Pepewitch/wisp/v0.6.3/scripts/uninstall.sh | sh
```
