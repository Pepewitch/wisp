...
This guide covers Wisp **0.5.3**, the current daemon and Desktop release of the
...
[release notes](v0.5/RELEASE-NOTES-0.5.3.md) and
...
0.5.3, use the Tauri updater. Homebrew remains the recovery path:
