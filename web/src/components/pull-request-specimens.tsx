    ...
    <>
      ...
      <div className="mt-4 flex items-center gap-3">
        <PullRequestStatusLink
          ...
          autoMerge={{ autoMerge: true, autoFix: false, pr: PR_SPECIMEN.number, state: "waiting", reason: "Waiting for checks (2 running)", about: "pr", mergedByWisp: false, pendingFix: null, fixRounds: 0, updatedAt: null }}
        />
        <span className="text-[11.5px] text-muted-foreground">
      ...
      <div className="mt-4 flex items-center gap-3">
        <PullRequestStatusLink
          ...
          autoMerge={{ autoMerge: false, autoFix: false, pr: PR_SPECIMEN.number, state: "merged", reason: "Merged by Wisp", about: "pr", mergedByWisp: true, pendingFix: null, fixRounds: 0, updatedAt: null }}
        />
