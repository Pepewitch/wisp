...
export function useAutopilotChoice(
  mode: TaskMode,
  initial?: AutopilotChoice,
): { picker: ReactNode; body: { autopilot?: AutopilotChoice }; value: AutopilotChoice } {
  const [value, setValue] = useState<AutopilotChoice>(initial ?? { autoMerge: false, autoFix: false })
