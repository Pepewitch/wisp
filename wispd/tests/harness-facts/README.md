...
`bun run harness:snapshot`, asserted by `wispd/tests/harness-facts.test.ts`.
...
The per-assertion comments in `wispd/src/adapters/` and the table in
`wispd/tests/fixtures/README.md` explain *why* a pin is what it is, and stay. These
