...
describe("the web app", () => {
  ...
  /**
   * The favicon is generated into web/index.html by scripts/brand/build.ts,
   * so it can drift from brand/favicon.svg if someone hand-edits either source.
   * Assert the generated bytes against the source of truth.
   */
