...
EVALUATOR_DIR="$ROOT/wispd/scripts/evaluator"
VERSION="0.5.1"
...
usage:
  ...
  wispd/scripts/evaluator/run.sh --model <id> --droid-api-key-file <path> [--rebuild-image]
  wispd/scripts/evaluator/run.sh --all --droid-api-key-file <path> [--rebuild-image]
